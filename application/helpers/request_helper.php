...
class request_helper
{
   ...
   * @deprecated   12.1
   */
  public static function setVar($name, $value = null, $hash = 'method', $overwrite = true, $time = 86400)
  {
  ...
  public static function clean()
  {
    ...
    // Remove this code when PHP 5.4 becomes the minimum require_oncement.
  ...
  public static function SetInfoMessages($message, $type='info')
  {
    if (!empty($message)) {
      self::setVar('InfoMessages', $message, 'SESSION');
      self::setVar('InfoMessagesType', $type, 'SESSION');
    }
  }
}
