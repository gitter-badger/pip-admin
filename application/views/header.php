...
<head>
  ...
  <meta name="description" content="Административная панель, разработчик GAAlferov">
  ...
  <!-- Timeline CSS -->
  <link href="<?php echo BASE_URL; ?>static/css/plugins/timeline.css" rel="stylesheet">
  <!-- Custom CSS -->
  ...
  <!-- Redactor -->
  <link href="<?php echo BASE_URL; ?>static/css/redactor.css" rel="stylesheet" type="text/css">
